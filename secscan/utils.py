...
__all__ = ['stockDataRoot', 'requestUrl', 'downloadSecUrl', 'secIndexUrl', 'downloadSecSoup', 'getCombString',
           'secUrlPref', 'pageUnavailableRE', 'spacesPat', 'openFp', 'pickSave', 'pickLoad', 'pickLoadIfPath',
           'savePklToDir', 'loadPklFromDir', 'saveSplitPklToDir', 'loadSplitPklFromDir', 'curEasternUSTime',
           'easternUSTimeZone', 'printSamp']
...
def secIndexUrl(accessNo, includePref=False) :
    "Given an accession no, returns SEC url for the form index page."
