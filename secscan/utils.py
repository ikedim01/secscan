...
__all__ = ['boto3_available', 'setStockDataRoot', 'stockDataRoot', 'requestUrl', 'secIndexUrl', 'downloadSecUrl',
           'getCombSoupText', 'secUrlPref', 'secRestDataPref', 'accessNoPatStr', 'accessNoPat', 'pageUnavailablePat',
           'spacesPat', 'compressGZipBytes', 'decompressGZipBytes', 'pickleToBytes', 'pickleFromBytes', 'pickSave',
           'pickLoad', 'pickLoadIfPath', 'pickSaveToS3', 'pickLoadFromS3', 'pickLoadFromS3Public', 'savePklToDir',
           'loadPklFromDir', 'saveSplitPklToDir', 'loadSplitPklFromDir', 'toDateStr', 'toDate', 'isWeekend',
           'dateStrsBetween', 'formatDateStr', 'dateStr8Pat', 'curEasternUSTime', 'easternUSTimeZone', 'secBrowse',
...
def downloadSecUrl(secSubUrlOrAccessNo, toFormat='text', sleepTime=0.1, restData=False) :
    ...
    urlContents = requestUrl(fullUrl).text
