...
__all__ = ['boto3_available', 'setStockDataRoot', 'stockDataRoot', 'setStockPriceRoot', 'stockPriceRoot', 'requestUrl',
           'setSecUserAgent', 'secIndexUrl', 'appendSpace', 'getCombTextRec', 'getCombSoupText', 'prTree',
           'prAllTagNames', 'downloadSecUrl', 'secUrlPref', 'secRestDataPref', 'secHeaders', 'secSleepTime',
           'accessNoPatStr', 'accessNoPat', 'spacesPat', 'tagsWithLeftSpace', 'pageUnavailablePat', 'delegates',
           'callDelegated', 'checkDelegated', 'compressGZipBytes', 'decompressGZipBytes', 'pickleToBytes',
