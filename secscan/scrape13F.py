...
__all__ = ['default13FDir', 'findChildEndingWith', 'findChildSeries', 'getRowInfo', 'parse13FHoldings', 'scraper13F',
           'callOptPat', 'putOptPat', 'condense13FHoldings', 'get13FHoldingsReportList', 'get13FAmendmentType',
           'indexMap', 'getHoldingsMap', 'addHoldingsMap', 'printRemoveStocksMessage', 'holdingsMapToMatrix',
           'getPeriodAndNextQStartEnd', 'getNSSForQ', 'saveConvMatrixPy2', 'qStartEnds', 'qPeriods']
...
@utils.delegates(condense13FHoldings)
def get13FHoldingsReportList(holdings, cusipNames={}, **kwargs) :
    ...
    Uses condense13FHoldings to condense, sort, and filter the returned list.
    """
    condensedH = condense13FHoldings(holdings, **kwargs)
...
def getHoldingsMap(scraped13F, period, **kwargs) :
    ...
    Uses condense13FHoldings to condense, sort, and filter the returned holdings and,
    ...
    for v,msg in [('minFrac','min stock fraction of portfolio'),
                  ...
                  ('minTopNFrac','min fraction of portfolio in top '
                                   + str(kwargs.get('minTopN')) + ' positions'),
    ...
    for cik, cik13FList in cikTo13Fs.items() :
        ...
        posList = condense13FHoldings(combHoldings, forCik=cik, **kwargs)
