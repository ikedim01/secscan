...
__all__ = ['default13FDir', 'findChildEndingWith', 'findChildSeries', 'getRowInfo', 'parse13FHoldings', 'scraper13F',
           'callOptPat', 'putOptPat', 'condenseHoldings', 'get13FAmendmentType', 'indexMap', 'cikConsolidatedHoldings',
           'getPeriodAndNextQStartEnd', 'getMatrixFor', 'saveConvMatrixPy2', 'qStartEnds', 'qPeriods']
...
def saveConvMatrixPy2(y, qNo, minFrac=0.12, maxFrac=0.4, minInvestorsPerStock=2, minStocksPerInvestor=1) :
    """
    Save a matrix of 13F conviction positions only for the given quarter,
    in a format readable by old Python 2 versions.
    """
    mat,ciks,cusips = getMatrixFor(y, qNo, minFrac=minFrac, maxFrac=maxFrac,
