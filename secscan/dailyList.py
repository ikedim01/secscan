...
__all__ = ['defaultDLDir', 'getQStr', 'getSecDailyIndexUrls', 'getDailyFList', 'downloadSecFormList', 'edgarTxtFPat',
           'isInFormClass', 'financialsPat', 'insiderPat', 'schedulePat', 'fivePctActivePat', 'fivePctPassivePat',
           'fivePctAllPat', 'managerPat', 'investorPat', 'namedFormClasses', 'noPeriodFormTypes', 'findCikName',
           'checkMapDates', 'dailyList', 'dlCountFilings', 'loadAndUpdateDL']
...
managerPat = '13F-HR'
investorPat = fivePctAllPat+'|'+managerPat
namedFormClasses = {  # readable names for some groups of form types
    'ALL' : '',
    'FINANCIALS' : re.compile(financialsPat, re.IGNORECASE),
    'INSIDER' : re.compile(insiderPat, re.IGNORECASE),
    'FIVEPCTACTIVE' : re.compile(fivePctActivePat, re.IGNORECASE),
    'FIVEPCTPASSIVE' : re.compile(fivePctPassivePat, re.IGNORECASE),
    'FIVEPCTALL' : re.compile(fivePctAllPat, re.IGNORECASE),
    'MANAGER' : re.compile(managerPat, re.IGNORECASE),
    'INVESTOR' : re.compile(investorPat, re.IGNORECASE),
}

noPeriodFormTypes = re.compile(fivePctAllPat+'|'+'424',re.IGNORECASE)
